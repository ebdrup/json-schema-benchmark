...
![performance](https://chart.googleapis.com/chart?chxt=x,y&cht=bhs&chco=76A4FB&chls=2.0&chbh=26,4,1&chs=600x410&chxl=-1:|is-my-json-valid|ajv|jsen|schemasaurus|themis|jsck|jjv|z-schema|skeemas|request-validator|jsonschema|tv4|jayschema&chd=t:100,95.8,91.9,30.1,28.1,11,7.8,7.8,1.4,0.7,0.6,0.3,0.1)

|Validator|Relative speed|Number of test runs per second|
|---------|:------------:|:----------------------------:|
|[`is-my-json-valid`](https://github.com/mafintosh/is-my-json-valid)|100%|14719 (± 0.61%)|
|[`ajv`](https://github.com/epoberezkin/ajv)|95.8%|14101 (± 0.71%)|
|[`jsen`](https://github.com/bugventure/jsen)|91.9%|13524 (± 3.68%)|
|[`schemasaurus`](https://github.com/AlexeyGrishin/schemasaurus)|30.1%|4429 (± 0.98%)|
|[`themis`](https://github.com/playlyfe/themis)|28.1%|4133 (± 3.4%)|
|[`jsck`](https://github.com/pandastrike/jsck)|11%|1618 (± 2.2%)|
|[`jjv`](https://github.com/acornejo/jjv)|7.8%|1145 (± 0.34%)|
|[`z-schema`](https://github.com/zaggino/z-schema)|7.8%|1142 (± 4.05%)|
|[`skeemas`](https://github.com/Prestaul/skeemas)|1.4%|212 (± 0.31%)|
|[`request-validator`](https://github.com/bugventure/request-validator)|0.7%|102 (± 5.49%)|
|[`jsonschema`](https://github.com/tdegrunt/jsonschema)|0.6%|91 (± 2.14%)|
|[`tv4`](https://github.com/geraintluff/tv4)|0.3%|37 (± 2.65%)|
|[`jayschema`](https://github.com/natesilva/jayschema)|0.1%|13 (± 2.3%)|
...
![failing tests](https://chart.googleapis.com/chart?chxt=x,y&cht=bhs&chco=76A4FB&chls=2.0&chbh=18,4,1&chs=600x416&chxl=-1:|ajv|skeemas|jsonschema|z-schema|jjv|is-my-json-valid|jayschema|jsen|themis|schemasaurus|jsck|request-validator|tv4|jassi|json-model|JSV|json-gate|revalidator&chd=t:1,1,3,3,4,9,10,11,13,15,21,26,26,31,40,54,70,199&chxr=0,0,199&chds=0,199)
