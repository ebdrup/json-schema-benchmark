...
`Recursive references between schemas, valid tree`|The schema failed to load(`Cannot read property '0' of undefined`). **This excludes this validator from performance tests**
